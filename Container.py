...
class Container:
    ...
    #Takes in drawing co-ordinates, height/width, background/fill colors, and how much it is filled up
    ...
    #Take in filled percentage as a decimal, multiply it by the height of container to get pixel height
